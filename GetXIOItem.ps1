...
function Get-XIOItemInfo {
	...
	param(
		...
		##   and, for XIOS version 4.0 and up:     "alert-definition", "bbu", "dae", "dae-controller", "email-notifier", "ldap-config", "local-disk", "slot", "snmp-notifier", "user-account", "xms"
		[parameter(ParameterSetName="ByComputerName")]
		[ValidateSet("alert-definition", "bbu", "cluster", "dae", "dae-controller", "data-protection-group", "email-notifier", "event", "ig-folder", "initiator-group", "initiator", "ldap-config", "local-disk", "lun-map", "slot", "snmp-notifier", "target-group", "target", "user-account", "volume", "volume-folder", "brick", "snapshot", "ssd", "storage-controller", "xenv", "xms")]
