...
function Get-XIOItemInfo {
	...
	param(
		...
		##   and, for XIOS version 4.0 and up:     "alert-definition", "alert", "bbu", "consistency-group", "dae", "dae-controller", "email-notifier", "ldap-config", "local-disk", "scheduler", "slot", "snapshot-set", "snmp-notifier", "user-account", "xms"
