...
$hshCfg = @{
	...
	ItemTypeInfoPerXiosVersion = @{
		...
		"4.0" = "alert-definitions", "alerts", "bbus", "consistency-groups", "daes", "dae-controllers", "email-notifier", "ldap-configs", "local-disks", "schedulers", "slots", "snapshot-sets", "snmp-notifier", "user-accounts", "xms"
	}
} ## end hashtable
